...
public class MelonMapper extends AbstractMongoDBComon implements IMelonMapper {
    ...
    public List<MelonDTO> getSongList(String colNm) throws Exception {
        ...
        // 조회 결과 중 출력할 컬럼들(SQL의 Select절과 From 절 가운데 컬럼들과 유사함)
        ...
        for (Document doc : rs) {
            ...
            log.info("MelonMapper.getSongList / Song : " + song);
            log.info("MelonMapper.getSongList / Singer : " + singer);
        ...
        log.info("MelonMapper : getSongList 끝 !");
    ...
    public List<MelonDTO> getSingerSongCnt(String colNm) throws Exception {
        ...
        log.info("MelonMapper : getSingerSongCnt 시작 !");
    ...
    public List<MelonDTO> getSingerSong(String pColNm, String pSinger) throws Exception {
        ...
        log.info("MelonMapper : getSingerSong 시작 !");
        ...
        // 조회 결과 중 출력할 컬럼들(SQL의 select절 from 절 가운데 컬럼들과 유사함)
        Document projection = new Document();
        projection.append("song", "$song");
        projection.append("singer", "$singer");
        ...
        // MongoDB의 find 명령어를 통해 조회할 경우 사용함
        // 조회하는 데이터의 양이 적은 경우, find를 사용하고, 데이터의 양이 많은 경우 무조건 Aggregate를 사용한다.
        ...
        log.info("MelonMapper : getSingerSong 끝 !");
        return rList;
    }
    ...
    public int insertSongMany(List<MelonDTO> pList, String colNm) throws Exception {
        ...
        log.info("MelonMapper : insertSongMany 시작 !");
        ...
        res = 1;
        log.info("MelonMapper : insertSongMany 끝 !");
